...
class NextcloudCalendarEventAdapterUtil
{
    ...
    public static function convertFromICalRScaleToJmapRScale($rscale)
    {
        ...
        // The JMAP rscale is essentially the iCal rscale, but simply in lowercase,
        // that's why return lowercased version of the input
